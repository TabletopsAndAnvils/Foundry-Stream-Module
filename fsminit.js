...
Hooks.on("renderChatMessage", (chatMessage, html, data) => { // R E N D E R   T A B B E D   C H A T
...
Hooks.on("diceSoNiceRollComplete", (id) => { // P L A Y   N I C E   W I T H   D S N
...
Hooks.on("createChatMessage", (chatMessage, content) => {  // C H A T   N O T I F I C A T I O N S
...
Hooks.on("preCreateChatMessage", (chatMessage, content) => { // T U R N   I C   M S G S   I N T O   O O C
